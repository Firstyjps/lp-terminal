...
export const en = {
  ...
  app: {
    ...
    keys: 'keys: [1] pools [2] positions [3] analyze [4] swap [5] limit',
  ...
  pools: {
    ...
    minVolLbl: 'VOL≥$',
    minVolTip: 'hide pools below this 24h volume (blank = off)',
    statsOnly: '24H DATA',
    statsOnlyTip: 'only pools with 24h volume/fee stats — hides rows showing —',
    watch: '★ ({{n}})',
    watchTip: 'watchlist only — star pools with the ☆ next to the pair name',
    watchAddTip: 'add to watchlist',
    watchRemoveTip: 'remove from watchlist',
    ...
    thVol: 'VOL 24H',
    thEff: 'VOL/TVL',
    effTip: 'capital efficiency — 24h volume per $1 of TVL; higher = the TVL works harder for fees',
    thFees: 'FEES 24H',
    thFeeApr: 'FEE APR',
    thRewards: 'REWARDS',
  ...
  pos: {
    ...
    trackedPnl: 'TRACKED PNL',
    trackedEarned: 'earned ≈ {{usd}}',
    trackedSub: '{{n}} tracked · since {{date}} · telegram alerts {{tg}}',
    pnlK: 'pnl',
    pnlEarned: 'fees+rewards ≈ {{usd}}',
    pnlSince: '(since {{date}})',
    rerange: 'RE-RANGE',
    rerangeTip: 'withdraw everything and re-mint centered on the current price (multiple tx, each wallet-signed)',
    rrWidth: 'NEW BAND',
    rrSame: 'SAME WIDTH',
    rrTight: 'TIGHT ×½',
    rrWide: 'WIDE ×2',
    rrPreview: '≈ {{lo}}–{{hi}} {{sym1}}/{{sym0}} (±{{pct}}%)',
    rrGo: 'EXECUTE RE-RANGE',
    rrConfirm: 'CONFIRM?',
    rrSteps: 'withdraw+collect → swap ≈half [KYBER] → mint. halts safely — funds stay in wallet',
    rrStepUnstake: 'unstake → ',
    rrNothing: 're-range: nothing came back from collect — aborting before mint',
    rrPlanFailed: 're-range halted after withdraw (funds are in your wallet): {{err}}',
    rrDust: 're-range dust: {{amt}} {{sym}} left in wallet — deploy it later via + INC',
    incRange: 'RANGE',
  ...
  vol: {
    indexing: 'indexing swaps · {{pct}}%',
    failed: 'vol failed: {{err}}',
    partial: 'partial — busy pool, oldest swaps trimmed',
    firstLoad: 'reading swap logs from chain — first open takes a moment',
    noData: 'no swap data for this pool/range',
    buy: 'BUY',
    sell: 'SELL',
    tVol: 'VOLUME',
    tNet: 'NET FLOW',
    tNetSub: 'buy − sell (CVD end)',
    tTrades: 'SWAPS',
    avg: 'avg {{v}}',
    tWallets: 'WALLETS',
    tWalletsSub: 'unique traders (tx.from)',
    traderless: '{{n}} swaps unattributed',
    tTop5: 'TOP5 SHARE',
    churn: 'churn {{v}}',
    washy: 'WASH?',
    chPrice: 'PRICE ({{quote}} per base, from swaps)',
    chFlow: 'BUY/SELL FLOW + CVD',
    topTraders: 'top wallets by volume',
    bigTrades: 'largest trades',
    thWallet: 'WALLET',
    thTotal: 'TOTAL',
    thBuy: 'BUY',
    thSell: 'SELL',
    ...
    thValue: 'VALUE',
    thPrice: 'PRICE',
    churnTip: 'buys ≈ sells — two-way churner (possible wash/bot)',
    thPnl: 'PNL',
    pnlTip: 'birdeye top-gainer #{{rank}} ({{win}}) on robinhood chain',
    secOk: 'SEC OK',
    secOkTip: 'gmgn token security: no honeypot / no unsafe alert',
    secHoneypot: 'HONEYPOT',
    secUnsafe: 'UNSAFE',
    secUnsafeTip: 'gmgn token security flagged this token — you may not be able to sell',
    source: 'on-chain swap logs since {{since}} · usd valued at current {{quote}} price',
    coverageShort: 'coverage shorter than the selected range',
  },
  an: {
    loading: 'loading chain analytics',
    failed: 'defillama fetch failed: {{err}}',
    tvl: 'CHAIN TVL',
    vol24: 'DEX VOL 24H',
    fees24: 'FEES 24H',
    stables: 'STABLES MCAP',
    vol7: 'VOL 7D',
    fees7: 'FEES 7D',
    d30: '30d',
    chg1d: '1d',
    chTvl: 'TVL',
    chVol: 'DAILY DEX VOLUME',
    chFees: 'DAILY FEES',
    r30: '30D',
    r90: '90D',
    rAll: 'ALL',
    dips: 'dips — trusted tokens dumping · {{n}}',
    thDipToken: 'TOKEN',
    thDipPrice: 'PRICE',
    thDipLiq: 'DEEPEST POOL',
    dipsNote: 'own-chain data: −20%/1h or −30%/24h · trusted pricing only · deepest clean pool ≥ $15k — check VOL (CVD) before acting. DYOR.',
    smartBuys: 'smart buys — top-pnl wallets buying · {{n}} (48h)',
    thSbTime: 'TIME',
    thSbUsd: 'SIZE',
    thSbWallet: 'BUYER (BIRDEYE RANK)',
    smartBuysNote: 'on-chain transfers by birdeye top-gainer wallets (bots filtered) · gmgn security-gated · 🔔 = telegram alerted. copy-trading is still gambling — DYOR.',
    protocols: 'protocols on chain · {{n}}',
    thProto: 'PROTOCOL',
    thCat: 'CATEGORY',
    thVol24: 'VOL 24H',
    thVol7: 'VOL 7D',
    ...
    insSpike: 'ANOMALY',
    insLead: 'LEADERS',
    insWow: 'WoW · 7d {{cur}} vs {{prev}} prior week',
    insAprTxt: 'annualized, was {{prev}}% — 7d DEX fees ÷ chain TVL (avg LP-side yield)',
    insTakeTxt: 'of volume, was {{prev}}bps — avg effective DEX fee rate',
    insTvlTxt: '7d · stablecoins {{flow}} 7d',
    insKindNew: 'mostly new money inflow',
    insKindPrice: 'mostly price / asset moves',
    insKindOut: 'net outflow',
    insSpikeTxt: 'yesterday {{v}} = {{x}}× the 30d daily average',
