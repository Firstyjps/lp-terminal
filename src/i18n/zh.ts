...
export const zh: typeof en = {
  ...
  app: {
    ...
    keys: '快捷键: [1] 池子 [2] 仓位 [3] 分析 [4] 兑换 [5] 限价',
  ...
  pools: {
    ...
    minVolLbl: 'VOL≥$',
    minVolTip: '隐藏 24h 量低于此值的池（留空 = 关闭）',
    statsOnly: '24H 数据',
    statsOnlyTip: '仅显示有 24h 量/费数据的池 — 隐藏显示 — 的行',
    watch: '★ ({{n}})',
    watchTip: '仅看关注列表 — 点击交易对旁的 ☆ 加关注',
    watchAddTip: '加入关注列表',
    watchRemoveTip: '移出关注列表',
    loading: '> 正在从工厂枚举池子',
    ...
    thVol: '24H 量',
    thEff: '量/TVL',
    effTip: '资金效率 — 每 $1 TVL 的 24h 交易量；越高说明 TVL 赚费越勤',
    thFees: '24H 费',
    thFeeApr: '费率 APR',
    thRewards: '排放奖励',
    sortTip: '点击排序',
  ...
  pos: {
    ...
    trackedPnl: '跟踪盈亏',
    trackedEarned: '已赚 ≈ {{usd}}',
    trackedSub: '跟踪 {{n}} 个仓位 · 自 {{date}} · telegram 提醒 {{tg}}',
    pnlK: '盈亏',
    pnlEarned: '手续费+奖励 ≈ {{usd}}',
    pnlSince: '（自 {{date}}）',
    rerange: '调仓 RE-RANGE',
    rerangeTip: '全部提取后以当前价格为中心重新铸造（多笔交易，逐笔钱包签名）',
    rrWidth: '新区间',
    rrSame: '同宽',
    rrTight: '收窄 ×½',
    rrWide: '放宽 ×2',
    ...
    rrGo: '执行调仓',
    rrConfirm: '确认？',
    rrSteps: '提取+领取 → 换 ≈一半 [KYBER] → 铸造。任一步中断资金都留在钱包，安全',
    rrStepUnstake: '解押 → ',
    rrNothing: '调仓：collect 没有返回任何代币 — 在铸造前中止',
    rrPlanFailed: '调仓在提取后中止（资金已在钱包）：{{err}}',
    rrDust: '调仓余尘：{{amt}} {{sym}} 留在钱包 — 可稍后用 + INC 投入',
    incRange: '区间',
  ...
  vol: {
    indexing: '正在索引 swap · {{pct}}%',
    failed: 'vol 加载失败: {{err}}',
    partial: '部分数据 — 交易过多，最早的 swap 被截断',
    firstLoad: '正在从链上读取 swap 日志 — 首次打开需要一点时间',
    noData: '该池/区间没有 swap 数据',
    buy: '买入',
    sell: '卖出',
    tVol: '成交量',
    tNet: '净流入',
    ...
    avg: '均笔 {{v}}',
    tWallets: '钱包数',
    tWalletsSub: '独立交易者 (tx.from)',
    traderless: '{{n}} 笔未归因',
    tTop5: 'TOP5 占比',
    churn: '对倒 {{v}}',
    washy: '刷量?',
    chPrice: '价格 (每 base 的 {{quote}}，源自 swap)',
    chFlow: '买/卖流向 + CVD',
    topTraders: '成交量最大的钱包',
    bigTrades: '最大单笔交易',
    thWallet: '钱包',
    ...
    thValue: '金额',
    thPrice: '价格',
    churnTip: '买 ≈ 卖 — 双向刷单钱包（疑似刷量/机器人）',
    thPnl: 'PNL',
    pnlTip: 'birdeye 盈利榜 #{{rank}}（{{win}}）robinhood 链',
    secOk: '安全检查通过',
    secOkTip: 'gmgn 代币安全：无 honeypot / 无危险警报',
    secHoneypot: 'HONEYPOT',
    secUnsafe: '危险',
    secUnsafeTip: 'gmgn 代币安全标记了该代币 — 可能无法卖出',
    source: '链上 swap 日志，起自 {{since}} · 按当前 {{quote}} 价格折算 usd',
    coverageShort: '覆盖范围短于所选区间',
  },
  an: {
    loading: '加载链上分析数据',
    failed: 'defillama 请求失败: {{err}}',
    tvl: '链 TVL',
    vol24: 'DEX 24H 交易量',
    fees24: '24H 费用',
    stables: '稳定币市值',
    ...
    thDipPrice: '价格',
    thDipLiq: '最深池子',
    dipsNote: '自有链上数据：1h −20% 或 24h −30% · 仅限可信定价 · 最深干净池 ≥ $15k — 操作前先看 VOL（CVD）。DYOR。',
    smartBuys: '聪明钱买入 — 高盈利钱包动向 · {{n}}（48h）',
    thSbTime: '时间',
    thSbUsd: '金额',
    thSbWallet: '买家（BIRDEYE 排名）',
    smartBuysNote: 'birdeye 盈利榜钱包的链上转账（已滤机器人）· 已过 gmgn 安全检查 · 🔔 = 已发 telegram 提醒。跟单仍是赌博 — DYOR。',
    protocols: '链上协议 · {{n}}',
    thProto: '协议',
    thCat: '类别',
    thVol24: '24H 量',
    ...
    insSpike: '异常',
    insLead: '头部协议',
    insWow: '周环比 · 7天 {{cur}} vs 上周 {{prev}}',
    insAprTxt: '年化，上周 {{prev}}% — 7天 DEX 费用 ÷ 链 TVL（LP 侧平均收益率）',
    insTakeTxt: '占交易量，上周 {{prev}}bps — DEX 平均有效费率',
    insTvlTxt: '7天 · 稳定币 {{flow}} 7天',
    insKindNew: '主要为新资金流入',
    insKindPrice: '主要为价格/资产波动',
    insKindOut: '净流出',
    insSpikeTxt: '昨日 {{v}} = 30 天日均的 {{x}} 倍',
